// === V8 MARKER START — do not remove ===
// V8 VERSION — for use with Max's `v8` object (not `js`).
//
// This file is generated by sync_v8_from_js.py from the SpiderMonkey-version
// source (marquee_selection_instancing.js). Do not edit by hand — changes
// here will be overwritten on next sync. Edit the JS file instead, then
...
//
// To use in a patch: replace `js marquee_selection_instancing.js` with
// `v8 marquee_selection_instancing_v8.js`. All outlets, inlets, and
// message handlers stay the same.
// === V8 MARKER END — do not remove ===
...
// (see the `texture` emit at the end of build_atlases). This is the V8 build,
// so it uses the _V8 suffix; the SpiderMonkey (js) build uses _JS.
var SYMBOL_ATLAS_NAME  = "SymbolAtlas_V8";
var PATTERN_ATLAS_NAME = "PatternAtlas_V8";
