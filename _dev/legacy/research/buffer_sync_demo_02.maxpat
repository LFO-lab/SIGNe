...
,
		"classnamespace" : "box",
		"rect" : [ 2260.0, 74.0, 2492.0, 1281.0 ],
		"gridonopen" : 2,
		"gridsize" : [ 15.0, 15.0 ],
		"gridsnaponopen" : 2,
		"objectsnaponopen" : 0,
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 855.0, 90.0, 157.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 855.0, 120.0, 100.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 390.0, 105.0, 22.0 ],
					"text" : "animate $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 390.0, 50.0, 22.0 ],
					"text" : "total $1"
				}
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						"filename" : "buffer_sync_partial.js",
						"parameter_enable" : 0
					}
,
					"text" : "js buffer_sync_partial.js"
				}
...
, 			{
				"box" : 				{
					"filename" : "buffer_sync_partial_v8.js",
					"id" : "obj-20",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 4,
...
,
					"text" : "v8 buffer_sync_partial_v8.js",
					"textfile" : 					{
						"filename" : "buffer_sync_partial_v8.js",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 90.0, 780.0, 870.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 5 ],
					"midpoints" : [ 504.5, 647.5, 631.375, 647.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 6 ],
					"midpoints" : [ 759.5, 647.5, 737.75, 647.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 7 ],
					"midpoints" : [ 999.5, 647.5, 844.125, 647.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 8 ],
					"midpoints" : [ 1239.5, 752.5, 950.5, 752.5 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 943.166666666666629, 468.5, 759.5, 468.5 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 991.833333333333371, 483.5, 999.5, 483.5 ],
					"source" : [ "obj-20", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 1040.5, 498.5, 1239.5, 498.5 ],
					"source" : [ "obj-20", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 202.5, 689.5, 205.875, 689.5 ],
					"source" : [ "obj-8", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 114.5, 689.5, 99.5, 689.5 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"name" : "buffer_sync_partial_v8.js",
				"bootpath" : "~/Documents/GitHub/SIGNe/js",
				"patcherrelativepath" : "../js",
				"type" : "TEXT",
				"implicit" : 1
