...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 765.0, 735.0, 150.0, 103.0 ],
					"text" : "only have vertex_attr0 through 3 (full list is in jit.gl.buffer doc page)\n\nhave to explicitly pass colour values through vertex shader?"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 286.0, 285.0, 26.0, 22.0 ],
									"text" : "!- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 223.0, 324.0, 67.0, 22.0 ],
									"text" : "scale 0 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 289.0, 249.0, 25.0, 22.0 ],
									"text" : "!/ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 287.0, 225.0, 28.0, 22.0 ],
									"text" : "dim"
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1035.0, 585.0, 233.0, 22.0 ],
					"text" : "jit.gl.texture tut @rectangle 0 @name tex1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 1035.0, 555.0, 335.0, 22.0 ],
					"text" : "jit.movie @output_texture 1 @moviefile chickens.mp4 @vol 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 675.0, 315.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1068.0, 91.0, 210.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 148.0, 90.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
,
					"patching_rect" : [ 675.0, 390.0, 100.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_buffer", "" ],
					"patching_rect" : [ 675.0, 435.0, 262.0, 22.0 ],
					"text" : "jit.gl.buffer tut @type vertex_attr0 @instanced 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.0, 20.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 1065.0, 135.0, 100.0, 77.0 ],
					"text" : "jit.gl.camera tut @position 0 0 2 @lookat 0 0 0 @tripod 1 @locklook"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 205.0, 88.0, 492.0, 22.0 ],
					"text" : "jit.world tut @fsaa 1 @size 320 240 @floating 1 @erase_color 0.2 0.2 0.2 1 @fsmenubar 0"
				}
