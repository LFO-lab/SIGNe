...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 435.0, 195.0, 460.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 900.299148797988892, 464.145299136638641, 141.025642454624176, 50.0 ],
					"text" : "jit.gl.buffer SIGNe @type instance_texcoord @instanced 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_buffer", "" ],
					"patching_rect" : [ 1349.871802926063538, 449.615384459495544, 135.042736411094666, 64.0 ],
					"text" : "jit.gl.buffer SIGNe @type instance_rotation @instanced 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_buffer", "" ],
					"patching_rect" : [ 719.957266628742218, 465.0, 134.786317944526672, 50.0 ],
					"text" : "jit.gl.buffer SIGNe @type instance_color @instanced 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_buffer", "" ],
					"patching_rect" : [ 555.0, 465.0, 134.700851202011108, 50.0 ],
					"text" : "jit.gl.buffer SIGNe @type instance_scale @instanced 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_buffer", "" ],
					"patching_rect" : [ 15.384615540504456, 480.0, 119.615384459495544, 50.0 ],
					"text" : "jit.gl.buffer SIGNe @type instance_pos @instanced 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 645.0, 547.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 135.0, 554.230768918991089, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 585.0, 298.0, 22.0 ],
					"text" : "jit.gl.gridshape SIGNe @shape plane @matrixoutput 1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 144.5, 626.0, 24.5, 626.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 564.5, 632.5, 24.5, 632.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 729.457266628742218, 632.5, 24.5, 632.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 1359.371802926063538, 632.0, 24.5, 632.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 909.799148797988892, 632.072649568319321, 24.5, 632.072649568319321 ],
					"source" : [ "obj-9", 0 ]
				}
